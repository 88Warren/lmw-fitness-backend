...
func AdvancedWorkoutDaySeed() {
	...
	exercises := []string{
		...
		"Wall Sits", "Tricep Dips (Floor)", "Squat Hold", "Squat Kicks", "Sprawls", "Overhead Jabs (Fast)",
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					...
					{Order: 5, ExerciseID: exIDs["Tricep Dips (Floor)"], Instructions: "Minute 5", Reps: "15"},
				},
			},
		},
	})
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					...
					{Order: 3, Instructions: "Minute 3", ExerciseID: exIDs["Tricep Dips (Floor)"], Reps: "15"},
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				BlockNotes:  "50s work, 10s rest.",
				Exercises: []models.WorkoutExercise{
					{Order: 1, ExerciseID: exIDs["Press Up Twists"], Tips: "With Twists", Duration: "50s", Rest: "10s"},
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					...
					{Order: 4, ExerciseID: exIDs["Tricep Dips (Floor)"], Reps: "15"},
