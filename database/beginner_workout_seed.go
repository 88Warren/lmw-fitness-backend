		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					{Order: 1, Instructions: "Minute 1", ExerciseID: exIDs["Squat Jumps"], Reps: "10"},
					{Order: 2, Instructions: "Minute 2", ExerciseID: exIDs["Press Ups"], Reps: "8"},
					{Order: 3, Instructions: "Minute 3", ExerciseID: exIDs["Jump Lunge"], Reps: "6", Tips: "2 Lunges = 1 rep"},
					{Order: 4, Instructions: "Minute 4", ExerciseID: exIDs["Crunches"], Reps: "15"},
					{Order: 5, Instructions: "Minute 5", ExerciseID: exIDs["Explosive Starjumps"], Reps: "10"},
				},
			},
		},
	}
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					{Order: 1, Instructions: "Minute 1", ExerciseID: exIDs["Squat Jumps"], Reps: "15"},
					{Order: 2, Instructions: "Minute 2", ExerciseID: exIDs["Plank Hold"], Reps: "30s"},
					{Order: 3, Instructions: "Minute 3", ExerciseID: exIDs["Press Ups"], Reps: "15"},
					{Order: 4, Instructions: "Minute 4", ExerciseID: exIDs["Explosive Starjumps"], Reps: "30"},
				},
			},
		},
	}
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				BlockNotes:  "16 minutes",
				Exercises: []models.WorkoutExercise{
					{Order: 1, Instructions: "Minute 1", ExerciseID: exIDs["H.O.G. Press Ups"], Reps: "20"},
					{Order: 2, Instructions: "Minute 2", ExerciseID: exIDs["Squat Jumps"], Reps: "20"},
					{Order: 3, Instructions: "Minute 3", ExerciseID: exIDs["Diamond Press Ups"], Reps: "20"},
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					{Order: 1, Instructions: "Minute 1", ExerciseID: exIDs["Press Ups"], Reps: "15"},
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					...
					{Order: 2, Instructions: "Minute 2", ExerciseID: exIDs["Press Ups"], Reps: "12"},
					{Order: 3, Instructions: "Minute 3", ExerciseID: exIDs["Jump Lunge"], Reps: "10", Tips: "2 Lunges = 1 rep"},
