...
func BeginnerWorkoutDaySeed() {
	...
	day1 := models.WorkoutDay{
		...
		Description: "Complete these 10 exercises for 1 minute each. Record the results in the email attachment table",
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					...
					{Order: 6, ExerciseID: exIDs["Diamond Sit Ups"], Reps: "Max Effort", Duration: "1 min", Rest: "2 mins"},
				},
			},
		},
	}
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					{Order: 1, ExerciseID: exIDs["Squats"], Duration: "45s", Rest: "15s"},
					{Order: 2, ExerciseID: exIDs["Lunges"], Duration: "45s", Rest: "15s"},
					{Order: 3, ExerciseID: exIDs["Calf Raises"], Duration: "45s", Rest: "15s"},
					{Order: 4, ExerciseID: exIDs["Glute Bridges"], Duration: "45s", Rest: "15s"},
					{Order: 5, ExerciseID: exIDs["Leg Raises"], Duration: "45s", Rest: "15s"},
					{Order: 6, ExerciseID: exIDs["Donkey Kicks"], Duration: "45s", Rest: "15s"},
				},
			},
		},
	}
		...
		WorkoutBlocks: []models.WorkoutBlock{
			{
				...
				Exercises: []models.WorkoutExercise{
					...
					{Order: 2, ExerciseID: exIDs["Tricep Dips"], Duration: "30s", Rest: "15s", Tips: "Can do on chair, sofa or step if you have one."},
